...
class Config:
    ...
    LABEL_ORIENTATION = os.environ.get("LABEL_ORIENTATION", "landscape")  # landscape | portrait
    ...
    LABEL_SAVE_LABEL_FILES = os.environ.get("LABEL_SAVE_LABEL_FILES", "true").lower() in {
        "1",
        "true",
        "yes",
    }
    ...
    GOOGLE_SHEETS_SYNC_ENABLED = os.environ.get("GOOGLE_SHEETS_SYNC_ENABLED", "false").lower() in {
        "1",
        "true",
        "yes",
    }
    GOOGLE_SHEETS_SPREADSHEET_ID = os.environ.get("GOOGLE_SHEETS_SPREADSHEET_ID", "").strip()
    GOOGLE_SHEETS_WORKSHEET = os.environ.get("GOOGLE_SHEETS_WORKSHEET", "PrintJobs").strip()
